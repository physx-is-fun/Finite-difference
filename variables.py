...
# Characteristic time, distance and amplitude scales
T = duration                                                                       # Characteristic time scale
Z = Length                                                                         # Characteristic distance scale